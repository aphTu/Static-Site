...
class TestParseInline(unittest.TestCase):
  ...
  def test_no_delimiter(self):
    node = InlineNode(content="This is a text with a normal text", text_type=TextType.TEXT)
    delimiter = [
      ("**", TextType.BOLD),
      ("_", TextType.ITALIC),
      ("`", TextType.CODE),
    ...
    new_nodes = parse_inline(node,delimiter)
    self.assertEqual(new_nodes, [InlineNode(content="This is a text with a normal text", text_type=TextType.TEXT)])
  
  def test_unbalance_delimiter(self):
    node = InlineNode(content="This is text with an _unblanced delimiter ", text_type=TextType.TEXT)
    delimiter = [
      ("**", TextType.BOLD),
      ("_", TextType.ITALIC),
      ("`", TextType.CODE),
    ...
    with self.assertRaises(Exception):
      print(parse_inline(node, delimiter))
